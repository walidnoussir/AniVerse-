...
function AnimeCard({ anime }) {
  return (
    <Link to={`/anime/${anime.mal_id}`}>
      <article className="group overflow-hidden rounded-xl bg-surface border border-white/5 transition-all duration-300 hover:-translate-y-2 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary-container/20 cursor-pointer">
